...
class PostRepository {
    ...
    //    private val userRepository = UserRepository()
        ...
        suspend fun getPostById(postId: String): Post? {
            return try {
                val result = this.db.collection(COLLECTION_POSTS).document(postId).get().await()
            ...
            try {
                ...
                db.collection(COLLECTION_POSTS)
                    ...
                    .addOnSuccessListener { docRef ->
                        ...
                        UserRepository.addUserCreatedPosts(newPost.authorEmail, document.id)
                    }
            ...
            try {
                db.collection(COLLECTION_POSTS)
                    ...
                    .addOnSuccessListener {
                        ...
                        UserRepository.removeUserCreatePosts(postId, authorEmail)
                    }
