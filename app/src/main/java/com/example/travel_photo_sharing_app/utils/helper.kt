...
fun initializePosts(context: Context): MutableList<Post> {
    val postsToBeDisplay = mutableListOf<Post>()
    val sampleUser = User("John Doe", "johndoe@example.com", "placedholder", mutableListOf(), "joe@gmail.com", "+123456789")
